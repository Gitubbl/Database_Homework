...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Integer> queryBook_ID() {
        return bookRepository.queryBook_ID();
    }

    @Override
    public Integer NumberOfBook() {
        return bookRepository.NumberOfBook();
    }

    @Override
    public List<String> queryCallNumber() {
        return bookRepository.queryCallNumber();
    }
